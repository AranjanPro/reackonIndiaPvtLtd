...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register Here"} primary={true} style={style} onClick={(event) => this.handleClick(event,'reckonuser')}/>
       </div>
       </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      reckonuserbuttonLabel:'Register Here',
      isLogin:true
    }
  }
  componentWillMount(){
  ...
  handleClick(event,userRole){
    ...
    if(this.state.isLogin){
      ...
      loginButtons.push(
        ...
        <MuiThemeProvider>
          <div>
             <RaisedButton label={"Register"} primary={true} style={style} onClick={(event) => this.handleClick(event,'reckonuser')}/>
         </div>
         </MuiThemeProvider>
        </div>
      )
